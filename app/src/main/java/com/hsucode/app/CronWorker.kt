...
class CronWorker(appContext: Context, params: WorkerParameters) : CoroutineWorker(appContext, params) {
    ...
    companion object {
        ...
        private const val CHANNEL_ID = "hsucode_cron"
    }

    override suspend fun doWork(): Result {
        val app = applicationContext as? HsucodeApplication ?: return Result.success()
    ...
    private suspend fun runJob(app: HsucodeApplication, prompt: String): String {
