 ...
 *
 * HSUCODE already extracts memories from every finished turn (see [com.hsucode.data.MemoryExtractor]).
...
class RecallMemoryTool(
    ...
    override suspend fun execute(params: Map<String, String>): ToolResult {
        ...
        val pid = com.hsucode.tools.WorkspaceContext.projectId
        val ftsHits = try {
        ...
        val merged = mutableListOf<com.hsucode.data.MemoryEntity>()
