...
object EmbeddingService {
     ...
     */
    fun hybridRank(
        ftsResults: List<com.hsucode.data.MemoryEntity>,
        queryVector: FloatArray,
        embeddedCandidates: List<com.hsucode.data.MemoryEntity>,
        vectorWeight: Float = 0.5f,
        limit: Int = 20
    ): List<com.hsucode.data.MemoryEntity> {
        ...
        data class Scored(val memory: com.hsucode.data.MemoryEntity, val score: Float)
