...
这些图标用于识别用户所配置的 AI 服务提供商。DeepSeek、OpenAI、Anthropic、Groq、智谱、通义千问、Moonshot、百度、Ollama、Nous、OpenRouter、xAI、ModelScope、SiliconFlow 与 OpenCode 等名称及标志分别属于其权利人；HSUCODE 与这些提供商不存在暗示的隶属或背书关系。
